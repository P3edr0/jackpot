...
abstract class Responsive {
  ...
  static Size? get sizeDeviceWithPixelRatio => Size(
        _size!.width * _pixelRatio!,
        _size!.height * _pixelRatio!,
      );
  ...
  static double getHeightValue(double value) => value * _heightFactor;
